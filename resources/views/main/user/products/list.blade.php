            ...
            <div class="card-body">
              <h5 class="card-title">Product List</h5>
                    <div class="d-flex justify-content-end py-2">
                        <a href="{{route('user#productAddPage')}}" class="btn btn-primary">Add Product</a>
                    </div>
                <div class="py-2">
                    @if (session('success'))
                        ...
                        <tbody>
                            @foreach ($product as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <a href="{{route('user#productView',$item->id)}}" class="btn btn-secondary btn-sm my-2" title="See More"><i class="bx bx-show"></i></a>
                                            @if ($item->user_id==Auth::user()->id)
                                                <a href="{{route('user#editProduct',$item->id)}}" class="btn btn-success btn-sm my-2" title="Edit category"><i class="bi bi-hammer"></i></a>
                                                <a href="{{route('user#deleteProduct',$item->id)}}" class="btn btn-danger btn-sm my-2" title="Remove category"><i class="bi bi-trash"></i></a>
                                            @endif
