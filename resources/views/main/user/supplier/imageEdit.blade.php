...
@section('content')
    <div class="pagetitle">
        <h1>Edit Supplier Product Image</h1>
        <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('user#supplier_productList')}}">List</a></li>
              <li class="breadcrumb-item"><a href="{{route('user#supplier_editProduct',$product->id)}}">Edit</a></li>
    ...
    <div class="">
        <div class="shadow rounded p-3">
            ...
            <div class=" d-flex justify-content-end">
                <button class="btn btn-primary" id="add_btn"><i class="fa-solid fa-plus me-2"></i>Add Room Image</button>
            </div>
            <div class="py-2">
                @if (session('success'))
            ...
            <div class="row p-2">
                @foreach ($product->image as $item)
                    <div class="col-md-4 nav-item p-2">
                        <form action="{{route('user#supplier_updateProductImage')}}" method="post" enctype="multipart/form-data" class="parents">
                            @csrf
                            <div class="py-2">
                            ...
                            <div class="d-flex justify-content-end gap-1">
                                ...
                                <a href="{{route('user#supplier_deleteProductImage',[$product->id,$loop->index])}}" class="btn btn-danger"><i class="fa-solid fa-trash me-2"></i>Remove</a>
                            </div>
                        </form>
                    </div>
                @endforeach
                <div class="col-md-4 nav-item p-2 d-none" id="add_form">
                    <form action="{{route('user#supplier_addProductImage')}}" method="post" enctype="multipart/form-data" class="parents">
                        @csrf
                        <div class="py-2">
