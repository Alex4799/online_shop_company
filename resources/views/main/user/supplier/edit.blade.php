...
@section('content')
    ...
    <div class="row">
        <div class="card col-md-8 offset-md-2">
            <div class="card-body">
              <h5 class="card-title text-center">Edit Supplier Product</h5>

              <form action="{{route('user#supplier_updateProduct')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="py-2 col-md-6">
                        <label for="name" class="d-flex justify-content-between"><p>Image</p><a href="{{route('user#supplier_editProductImage',$product->id)}}">Edit Image</a></label>
                        <div class="py-2">
