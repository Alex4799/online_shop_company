          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 label">Show Category</div>
                    <div class="col-lg-9 col-md-8">
                        @if (Auth::user()->show_category!=[])
                ...
                @if (Auth::user()->position!='supplier')
                    <div>
                        <a href="{{route('user#pendingSupplierPage')}}" class="btn btn-primary">Pending To Be Supplier</a>
                    </div>
                @endif
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <form action="{{route('user#profileUpdate')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      ...
                      <div class="pt-2">
                        <a href="{{route('user#deleteProfile',Auth::user()->id)}}" class="btn btn-danger btn-sm" title="Remove my profile image"><i class="bi bi-trash"></i></a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="py-2 d-flex justify-content-end">
                    <a href="{{route('user#showCategory')}}" class="btn btn-primary">Change Show Category</a>
                </div>
              </div>
