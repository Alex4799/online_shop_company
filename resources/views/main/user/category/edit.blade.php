...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('user#categoryList')}}">List</a></li>
    ...
    <div class="row">
        <div class="card col-md-8 offset-md-2">
            <div class="card-body">
              ...
              <form action="{{route('user#updateCategory')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="py-2">
                    ...
                    <input id="name" value="{{$category->name}}" placeholder="Enter your name ...." class="form-control" type="name" name="name" :value="old('name')" required autofocus>
                    @error('name')
                    <small class=" text-danger">{{$message}}</small>
                  @enderror
                </div>
