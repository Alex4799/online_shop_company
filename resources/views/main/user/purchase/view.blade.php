...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{route('user#listPurchase')}}">List</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 py-2">
                            <div>
                                ...
                                <h6 class="py-2">Supplier - {{$purchase->user_name}}</h6>
                                ...
                                <h6 class="py-2">Status - @if ($purchase->status==0)
                                    <span>Pending</span>
