                        ...
                        <tbody>
                            @foreach ($product as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <a href="{{route('user#supplierProductView',$item->id)}}" class="btn btn-secondary btn-sm my-2" title="See More"><i class="bx bx-show"></i></a>
                                            <a href="{{route('user#addPurchasePage',$item->id)}}" class="btn btn-warning btn-sm my-2" title="Buy"><i class="bx bxs-cart"></i></a>
