...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin#editProduct',$product->id)}}">Edit</a></li>
    ...
    <div class="">
        <div class="shadow rounded p-3">
            <h5 class="card-title text-center">Edit Product Image</h5>
            ...
            <div class="row p-2">
                @foreach ($product->image as $item)
                    <div class="col-md-4 nav-item p-2">
                        <form action="{{route('admin#updateProductImage')}}" method="post" enctype="multipart/form-data" class="parents">
                            @csrf
                            <div class="py-2">
                            ...
                            <div class="d-flex justify-content-end gap-1">
                                ...
                                <a href="{{route('admin#deleteProductImage',[$product->id,$loop->index])}}" class="btn btn-danger"><i class="fa-solid fa-trash me-2"></i>Remove</a>
                            </div>
                        </form>
                    </div>
                @endforeach
                <div class="col-md-4 nav-item p-2 d-none" id="add_form">
                    <form action="{{route('admin#addProductImage')}}" method="post" enctype="multipart/form-data" class="parents">
                        @csrf
                        <div class="py-2">
